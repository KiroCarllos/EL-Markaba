...
<center style="background-color:#E1E1E1;">
    <table  dir="ltr" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTbl"
            style="table-layout: fixed;max-width:100% !important;width: 100% !important;min-width: 100% !important;">
        <tr>
            <td align="center" valign="top" id="bodyCell">

                <table  dir="ltr" bgcolor="#E1E1E1" border="0" cellpadding="0" cellspacing="0" width="500" id="emailHeader">
                    <tr>
                            ...
                            <table  dir="ltr" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" valign="top">
                                        ...
                                        <table  dir="ltr" border="0" cellpadding="10" cellspacing="0" width="500"
                ...
                <table dir="ltr"  bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top" class="textContent">
                                                                <div
                                                                    ...
                                                                    <img src="http://el-markaba.kirellos.com/logo.PNG" width="200px" style="margin: auto;border-radius: 10px" alt="logo">
                                                                </div>
                                                                <br>
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            <h3
                                                                                ...
                                                                                Change your password in three easy steps.</h3>
                                                                            <div
                                                                                ...
                                                                                <ol>
                                                                                    <li>
                                                                                        Paste This Code Below In Your App.
                                                                                    </li>
                    ...
                    <tr>
                        <td align="center" valign="top">
                            <table dir="ltr"  border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#F8F8F8">
                                <tr>
                                    <td align="center" valign="top">
                                        <table  dir="ltr" border="0" cellpadding="0" cellspacing="0" width="500"
                                                class="flexibleContainer">
