        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.user_student_details')
                        <small>{{ count($user_student_details) }}</small></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('create_student_details') ||auth()->user()->hasRole('super_admin') )
                                    <a href="{{ route('dashboard.student_details.create') }}" class="btn btn-primary"><i
                                ...
                                @endif
                                @if (auth()->user()->hasPermission('create_student_details') ||auth()->user()->hasRole('super_admin') )
                                    <a href="{{ route('dashboard.student_details.export') }}" class="btn btn-primary"><i
                            ...
                            <table class="table table-bordered table-striped dataTable">
                                ...
                                @foreach ($user_student_details as $index=>$user_student_detail)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>
                                            <a href="{{ $user_student_detail->image }}" class="img-preview">
                                                <img src="{{ $user_student_detail->image }}" style="width: 100px;"
                                        ...
                                        <td>
                                            @if (auth()->user()->hasRole('super_admin'))
                                                <a href="{{ route('dashboard.student_details.edit', $user_student_detail->id) }}"
                                            ...
                                            @if (auth()->user()->hasRole('super_admin'))
                                                <form
                                                    action="{{ route('dashboard.student_details.destroy', $user_student_detail->id) }}"
